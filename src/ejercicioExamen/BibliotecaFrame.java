		...
		if (usuario instanceof UsuarioBasico) {
			...
			btnPrestar.addActionListener(e -> {
				...
				for (Libro l : biblioteca.getLibros()) {
					if (l.getIcbn().equals(icbn)) {
						...
						if (ok)
							JOptionPane.showMessageDialog(this, "Libro prestado: " + l.getTitulo());
						else
							JOptionPane.showMessageDialog(this,
									"No se pudo prestar (ya tiene uno o libro no disponible).", "Info",
									JOptionPane.INFORMATION_MESSAGE);
						break;
					}
				}
				if (!found)
					JOptionPane.showMessageDialog(this, "ICBN no encontrado.");
				mostrarLibros();
			});
			...
			btnDevolver.addActionListener(e -> {
				...
				if (ok)
					...
					JOptionPane.showMessageDialog(this, "No tiene libros prestados.", "Info",
							JOptionPane.INFORMATION_MESSAGE);
				mostrarLibros();
			});
			...
			btnCambiarEstado.addActionListener(e -> {
				...
				if (icbn == null)
					return;
				String estado = JOptionPane.showInputDialog(this,
						"Nuevo estado (Disponible/Prestado/Reservado/No disponible):");
				if (estado == null)
					return;
				boolean found = false;
				for (Libro l : biblioteca.getLibros()) {
			...
			btnAgregar.addActionListener(e -> {
				...
				} catch (NumberFormatException ex) {// mensaje de excepcion
					ed = 1;
				}
...
//reveer forma en la que se llaman los botones 